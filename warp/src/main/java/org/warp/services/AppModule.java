...
import org.warp.services.dao.admin.ActionURLDAOImpl;
import org.warp.services.dao.admin.AlertCriteriaDAO;
import org.warp.services.dao.admin.AlertCriteriaDAOImpl;
import org.warp.services.dao.admin.CommonConfigDAO;
import org.warp.services.dao.admin.CommonConfigDAOImpl;
import org.warp.services.dao.admin.HostDAO;
import org.warp.services.dao.admin.HostDAOImpl;
import org.warp.services.dao.admin.HostGroupDAO;
import org.warp.services.dao.admin.HostGroupDAOImpl;
import org.warp.services.dao.admin.MaintenanceWindowDAO;
import org.warp.services.dao.admin.MaintenanceWindowDAOImpl;
import org.warp.services.dao.admin.RoleDAO;
import org.warp.services.dao.admin.RoleDAOImpl;
import org.warp.services.dao.admin.TenantDAO;
import org.warp.services.dao.admin.TenantDAOImpl;
import org.warp.services.dao.admin.UserDAO;
import org.warp.services.dao.admin.UserDAOImpl;
import org.warp.services.navigation.CryptoService;
import org.warp.services.navigation.CryptoServiceImpl;
import org.warp.services.navigation.NavigationService;
import org.warp.services.navigation.NavigationServiceImpl;
...
public class AppModule
{
    public static void bind(ServiceBinder binder)
    {
    	...
    	binder.bind(ActionURLDAO.class, ActionURLDAOImpl.class);
    	binder.bind(HostGroupDAO.class, HostGroupDAOImpl.class);
    	binder.bind(MaintenanceWindowDAO.class, MaintenanceWindowDAOImpl.class);
    	binder.bind(UserDAO.class, UserDAOImpl.class);
    	binder.bind(RoleDAO.class, RoleDAOImpl.class);
    	binder.bind(CommonConfigDAO.class, CommonConfigDAOImpl.class);
    	binder.bind(TenantDAO.class, TenantDAOImpl.class);
    	binder.bind(HostDAO.class, HostDAOImpl.class);
      	binder.bind(AlertCriteriaDAO.class, AlertCriteriaDAOImpl.class);
        ...
        MappedConfiguration<String, Object> configuration)
    {
        ...
        configuration.add("GRID_MAX_RESULTS", 500);
    }
